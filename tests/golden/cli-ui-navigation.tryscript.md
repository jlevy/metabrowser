...
$ node tests/dom/navigation-route-behavior.js
{
  "verified": [
    ...
    "back onto a view route is not a page's",
    "root href",
    ...
    "native URL for a%5Cb.txt",
    "identity from /view/a%5Cb.txt",
    "native URL for %255C.md",
    "identity from /view/%255C.md",
    ...
    "format rejects NUL",
    "a page is not shown while it mounts",
    "a mounted page opens",
    "the mounted page is shown",
    "a tab link opens the tab",
    "the shown page's route opens without a push",
    "a landing the controller applies is left to it",
    "a tab keeps the page and puts the tab in the URL",
    "the served pull request's page opens",
    "the served pull request's page replaces the other",
    "the served pull request is shown",
    "a page a later route superseded is cancelled",
    "a page a file claim superseded is cancelled",
    "a superseded page is never shown",
    "superseded pages are disposed as they arrive",
    "a page another claim replaced is not shown",
    "back onto a replaced page mounts it",
    "no plugin leaves no page shown",
    "a replaced or unmounted page mounts again",
