// Behavior contract for static/pending_tally_diagnostics.js: one delayed
...
const source = fs.readFileSync(
  path.join(repoRoot, "src/metabrowser/static/pending_tally_diagnostics.js"),
  "utf-8",
);
vm.runInContext(source, sandbox, { filename: "pending_tally_diagnostics.js" });
