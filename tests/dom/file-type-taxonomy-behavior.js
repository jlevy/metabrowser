...
const source = fs.readFileSync(
  path.join(repoRoot, "src/metabrowser/static/file-type-taxonomy.js"),
  "utf8",
);
vm.runInContext(source, sandbox, { filename: "file-type-taxonomy.js" });
...
vm.runInContext(source, signedOrderSandbox, { filename: "file-type-taxonomy.js" });
