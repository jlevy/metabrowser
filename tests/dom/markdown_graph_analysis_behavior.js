...
(async () => {
  const scannerUrl = await dataModule("src/metabrowser/builtin_plugins/markdown/link_scanner.js");
  const linksUrl = await dataModule("src/metabrowser/builtin_plugins/markdown/links.js");
  const wikiUrl = await dataModule("src/metabrowser/builtin_plugins/markdown/wiki_resolver.js");
  const adaptersUrl = await dataModule(
    "src/metabrowser/builtin_plugins/markdown/project_adapters.js",
  );
  const githubUrl = await dataModule(
    "src/metabrowser/builtin_plugins/markdown/github_localizer.js",
  );
  const graphUrl = await dataModule("src/metabrowser/builtin_plugins/markdown/graph_analysis.js", [
    ["./link_scanner.js", scannerUrl],
    ["./links.js", linksUrl],
    ["./wiki_resolver.js", wikiUrl],
    ["./project_adapters.js", adaptersUrl],
    ["./github_localizer.js", githubUrl],
  ]);
