// Behavioural checks for static/tree_filter_model.js: what a filter selection
...
vm.runInContext(
  fs.readFileSync(path.join(repoRoot, "src/metabrowser/static/tree_filter_model.js"), "utf-8"),
  sandbox,
  { filename: "tree_filter_model.js" },
);
