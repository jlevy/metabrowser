// Behavioural checks for static/filter-state.js: transient defaults,
...
function makeSandbox(options) {
  ...
  const source = fs.readFileSync(
    path.join(repoRoot, "src/metabrowser/static/filter-state.js"),
    "utf-8",
  );
  vm.runInContext(source, sandbox, { filename: "filter-state.js" });
