...
//
// Usage:
//   node render-view.js <metabrowser_root> <kind> <view_id> '<json_payload>'
//
// Output: the container's innerHTML on stdout.
//
// Sandbox note: same minimal mocks as load-plugins.js; just enough
...
if (args.length !== 4) {
  fail("usage: render-view.js <repo_root> <kind> <view_id> '<json_payload>'");
}
