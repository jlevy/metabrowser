...
- [Git diff view](specs/active/plan-2026-07-18-git-diff-view.md)
...
- [Diff interface stacks and browser build and packaging options](research/research-2026-07-18-diff-ui-stacks-and-browser-build-options.md)
