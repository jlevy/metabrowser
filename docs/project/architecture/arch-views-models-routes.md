...
| `source.line-anchors` | interaction | `static/source-line-anchors.js#describe`, `static/source-line-anchors.js#nextFragment`, `static/source-line-anchors.js#mount`, `static/source-line-anchors.js#refresh`, `static/plugin-sdk.js#renderSourceView` | `/api/file` | `node tests/dom/source-line-anchors-session.js` | `cli-ui-source-line-anchors.tryscript.md` |
