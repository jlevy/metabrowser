...
| `source.pin-generation-guard` | interaction | `static/source-generation.js#guardFetch`, `static/source-generation.js#guardedRequest` | `/api/file`, `/api/tree`, `/api/source/status` | `node tests/dom/source-freshness-session.js` | `cli-ui-source-freshness.tryscript.md` |
