...
# `single-file` is deferred by the KPress v0.1.0 contract. Reject explicitly so callers
# see a clear 400 with the reason rather than a half-supported artifact. The external
# package is authoritative: https://github.com/jlevy/kpress/blob/v0.1.0/docs/kpress-design.md
