...
2026-09-22: the .pnpm-store ignore item is done in PR #226 (4002c608). A stray .pnpm-store/ in the primary checkout linked into attic/ and broke make verify's sdist check. The directory itself was left in place. The gh stack metadata and unpushed-branch items remain.
