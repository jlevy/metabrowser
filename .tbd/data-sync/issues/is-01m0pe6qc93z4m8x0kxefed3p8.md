...
updated_at: 2026-08-23T07:05:05.122Z
---
...
Sharpened by the exp-009 region audit. At first paint the files panel is 'Loading files...' at 21px where 612px of rows belong -- measured, on the fixed corpus at 1280x900. That growth does not shift anything (it is the last child of #tree-content, overflow-y: auto, no siblings after it), so it is filling rather than moving, and it is deliberately outside reserved_region_shift_px. It is still the larger fact about first paint: exp-009 stopped the frame moving, it did not make the frame exist.
