...
updated_at: 2026-09-23T04:26:31.614Z
closed_at: 2026-09-23T04:26:31.613Z
close_reason: Fixed on codex/v012-foundation-stabilization 60d91f7b. _write_subject_ref removes <ref>.lock under the store lock, which is exclusive across processes, while the lease excludes maintenance, so the lock can only be stale. It logs a warning. tests/test_git_revision_lease.py::test_a_stale_subject_ref_lock_does_not_block_later_pins covers first-pin and repeat-pin; both failed before the fix.
resolution: null
duplicate_of: null
---
