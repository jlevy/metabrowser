...
updated_at: 2026-09-18T01:31:37.531Z
...
Implemented on cursor/v011-file-url-grammar-bd04, stacked on PR #140. PR https://github.com/jlevy/metabrowser/pull/141. Production classify_root_argument replays url-grammar.json; CLI ROOT stays a string; file:// / https / ssh fail closed until mb-h51g. Ordinary local browsing skips cache.urls via _is_plain_local_root, pinned to the grammar fixture, so the layout import-boundary test stays true. Close when the layer is reviewed and CI is green, not when the stack merges to main.
