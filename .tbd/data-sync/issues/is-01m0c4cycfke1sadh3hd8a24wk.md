...
updated_at: 2026-08-19T16:19:42.755Z
---
...
Deferred with mb-uawv: Phase 1 reached the browser through the plugin data hook (house pattern), so the core /api/diff/ collection lands with the Phase 2 comparison context.
