...
updated_at: 2026-09-18T11:12:25.249Z
...
Stacked #194 (8262d9af) Git /api/file blob ext from derive_ext on #193. Folders and extensionless names omit ext. File envelopes omit logical_ext/compressed/size_uncompressed (no gzip smudge; observeNavigation would clobber catalog e). #193 CI still in progress on b60318d3. Remaining later: inventory coordinator open, archive containers (mb-380k), serving acquired Git (mb-ew38), CLI --show of a Git pin. Possible next after #193/#194 green: Git markdown /api/file frontmatter / highlight_disabled parity. Do not close mb-z335. Do not merge.
