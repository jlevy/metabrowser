...
updated_at: 2026-09-18T05:18:04.708Z
...
First slice stacked as draft #157 on #156 (branch cursor/v011-git-tree-source-bd04, commit b33e23f3). GitPath + GitRevisionSubject + GitTreeSource + exclusive cat-file batch actors; routes stay on the attached folder; acquired Git is not served. Do not close or merge. Remaining on this bead: route migration, shared per-store reader pool, revision leases/durable refs/GC lock, two-process tests, inventory open for Git subjects.
