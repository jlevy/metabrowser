...
updated_at: 2026-09-18T11:02:31.063Z
...
As-landed through #192 hide recency chrome (317bdd1f, stacked on #191). SPA omits Modified within and skips /api/recent on a pin; server recency still 409s. Stack tip: cursor/v011-git-revision-hide-recency-bd04. Remaining later: inventory coordinator open, archive containers (mb-380k), serving acquired Git (mb-ew38), CLI --show of a Git pin. Do not close until review.
