...
updated_at: 2026-09-18T15:26:38.859Z
...
New heads (draft PRs not created; #157–#199 remain open):
...
Forge write failed: `gh pr create` (GraphQL createPullRequest) and REST POST /pulls both 403 "Resource not accessible by integration" with X-Accepted-Github-Permissions: pull_requests=write. Auth is cursor[bot] ghs_ installation token; reads work; /user 403 is the same integration limit. Did not close #157–#199 because new layer PRs do not exist.
