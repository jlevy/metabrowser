...
updated_at: 2026-09-18T10:49:26.162Z
...
As-landed through #188 Git /api/tree filtered totals (de9e5fa9, stacked on #187 7-green). Next: Git logical-ext type matching on cursor/v011-git-revision-logical-ext-bd04 stacked on #188; derive_ext + SPA-style dotted-token match so notmd is not .md. Do not close until review.
