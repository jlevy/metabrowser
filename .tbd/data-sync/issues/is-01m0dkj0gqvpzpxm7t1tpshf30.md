...
updated_at: 2026-09-18T05:56:35.551Z
...
CI 7-green on #157 (tree source, b33e23f3), #158 (lease_revision, b2dd406b), and #159 (shared reader pool, 354a6f29). Fourth slice stacked as draft #160 on #159 (branch cursor/v011-git-revision-routes-bd04, commit 94d3c6ee): GitLocation so discovery/history/refs/detail honor GitRevisionSubject (detached HEAD at pin, default walk is the pin, never a cache path). Do not close or merge. Remaining: file/raw/tree GitPath routes, inventory open for Git subjects, production GC exclusive lock.
