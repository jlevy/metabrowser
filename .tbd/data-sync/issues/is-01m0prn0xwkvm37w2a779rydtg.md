...
updated_at: 2026-08-23T08:07:30.346Z
closed_at: 2026-08-23T08:07:30.345Z
close_reason: "Fixed in 552a41d. The reservation is scoped with :not(:has(+ .tree-summary-filtered)):not(:has(+ .tree-selection-note)), so it no longer reaches the state that drops the padding and border it was derived from. Verified in the browser: min-height resolves to 0 with a filtered sibling present, row height 56 -> 49, exactly the 7px."
---
