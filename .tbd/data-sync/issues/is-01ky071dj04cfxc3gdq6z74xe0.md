...
updated_at: 2026-07-23T23:05:47.104Z
---
...
Also in scope (Bugbot R6 deferral): folder-header numeric parity under visibility=hidden — the /api/file dir envelope needs unignored (later: filtered) aggregate variants so the header can match the treemap when hide modes are active; today header+nav intentionally report full totals while the treemap labels its filtered view.
