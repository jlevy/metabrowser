...
| `shell_tools_missing`, `plugin_view_containers`, `plugin_view_nonempty` | Application-adapter readiness and selected-view facts after settle | Prevents an asset-tier improvement from passing by silently losing deferred controls or the requested renderer |
